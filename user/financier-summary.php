  ...
  <div class="modal-dialog">
    <div class="modal-content">     
      <div class="modal-body">
        ...
        <button type="button" onclick="downloadPDF('<?= $_SESSION['invoice_no']; ?>')" class="btn btn-danger Print">Télècharger PDF</button>
      </div>
    </div>
  </div>
</div>
       ...
       <div class="card mt-4">
          <div class="card-header">
             <h4 class="mb-0">Financier Dossier
                <a href="financier-create.php" class="btn btn-danger float-end">Retourner pour créer</a>
            </h4>
          </div>
          <div class="card-body">
            <?php alertMessage(); ?>
            ...
            <div id="myBillingArea">
                    ...
                    if($projetQuery){
                        if(mysqli_num_rows($projetQuery) > 0){
                            ...
                            <tbody>
                                ...
                                <tr>
                                  <td>
                                      <h5 style="font-size: 20px; line-height: 30px; margin:0px; padding: 0;">Projet Detail</h5>
                                  ...
                                  <td align="end">
                                      <h5 style="font-size: 20px; line-height: 30px; margin:0px; padding: 0;">Détail de la facture</h5>
                ...
                <?php
                  if(isset($_SESSION['produitItems'])){
                    ...
                    echo '<h5 class="text-center">Aucun élément ajouté</h5>';
                  }
                   ?>
            ...
            <?php if(isset($_SESSION['produitItems'])) : ?>
              <div class="mt-4 text-end">
                ...
                <button class="btn btn-warning px-4 mx-1" onclick="downloadPDF('<?= $_SESSION['invoice_no']; ?>')">Télècharger PDF</button>
