...
<div class="container-fluid px-4">
   <div class="card mt-4 shadow-sm">
    ...
    <a href="projet-create.php" class="btn btn-primary float-end">Ajouter Projets</a>
    </h4>    
 </div>
    <div class="card-body">
...
<?php foreach($projet as $categorieitem):
 ...
 <tr>
   ...
   ?>
    ...
    <td>
    <a href="projet-edit.php?id=<?= $categorieitem['id']; ?> " class="btn btn-success btn-sm">Modifier</a>
